...
function readUserData() {
  ...
  var user = firebase.auth().currentUser;
  var itemNo = 1;
  var cmp = document.getElementById("sortby").value
  ...
  ref.on("value", function(snapshot) {
    snapshot.forEach(function(childSnapshot) {
      ...
      if (!childData.removed) {
        ...
        tr.id = "itemNo" + itemNo;
        var html = "<td id=\"itemName" + itemNo + "\">" + childData.name + "</td>"
        html += "<td id=\"" + itemNo + "\">" + childData.quantity + " " + childData.type + "</td>"
        html += "<td><div id=\"itemDate" + itemNo + "\" class=\"progress\"><div class=\"progress-bar progress-bar-striped active\" role=\"progressbar\" aria-valuenow=\"100\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width:100%\">" + childData.health + "</div>/div></td>"
        html += "<td id=\"buttons" + itemNo + "\"align=\"right\"><a><i class=\"fa fa-pencil fa-2x\" id=\"editpencil" + itemNo
